<template>
  <div class="flex flex-col  justify-center items-center">
    ...
    <div class="flex w-full gap-4">
      <SearchBar @searchStr="searchValue" @category="searchCategory" class="w-[18rem]" />
      ...
      <Grid :str="searchStr" :category="category" @idSelected="showDetail"  class="w-[18rem]" v-if="idSelected > 0"/>  
    </div>
